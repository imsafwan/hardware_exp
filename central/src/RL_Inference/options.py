...
def get_options(args=None):
    ...
    parser.add_argument('--ugv_graph_size', type=int, default=5, help="The number of the charging stations")
    ...
    parser.add_argument('--log_dir', default='Tensboard_log', help='Directory to write TensorBoard information to')
    ...
    parser.add_argument('--load_path' , help='Path to load model parameters and optimizer state from')  # default = 'outputs/mcsrp_15/run_20231121T161101/epoch-41.pt'
