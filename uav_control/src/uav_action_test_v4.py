...
MANAGER_IP = "192.168.10.233"  # central laptop / mission manager
        ...
        try:
            ...
            msg = {
                ...
                "uav_state": {
                    ...
                    "next_p": next_p,
                    "curr_p": curr_p,
                    "time_elapsed": time_elapsed + 2.00
                },
    ...
    try:
        if action_type == "takeoff_from_UGV":
            if dry_test:
                ...
                return await takeoff(drone, altitude=5.0)
            ...
            if dry_test:
                ...
                return await goto_gps_target_modi_2(
                    drone,
                    action["location"]["lat"], action["location"]["lon"], 8,
                    ref_lat, ref_lon, ref_alt,
                    speed_mps=1.25, arrival_thresh=0.25,
